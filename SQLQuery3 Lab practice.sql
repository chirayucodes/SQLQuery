...
SET StudentName= 'one ', FatherName= 'one ', mothername= 'one' , gender= 'M', dateofbirth= '2003-08-08', ADDRESS= 'salaiya'
...
(StudentName, FatherName, MotherName, DateOfBirth, Gender, Address, IsActive)
VALUES
('Aman Verma', 'Rajesh Verma', 'Sunita Verma', '2002-05-14', 'Male', 'Bhopal', 1),

('Sneha Kulkarni', 'Mahesh Kulkarni', 'Anita Kulkarni', '2001-11-22', 'Female', 'Pune', 0),

('Rohit Sharma', 'Dinesh Sharma', 'Kavita Sharma', '2003-02-10', 'Male', 'Indore', 1),

('Priya Nair', 'Suresh Nair', 'Lakshmi Nair', '2002-09-18', 'Female', 'Kochi', 0),

('Vikram Patel', 'Harish Patel', 'Meena Patel', '2001-07-30', 'Male', 'Ahmedabad', 1);
